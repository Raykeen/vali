...
{
  protected validations: ValidationFunctionAdapted<
    Value,
    ContextType,
    ValidationResult<ErrorType, ChildrenVResults | null>
  >[];
  #cache = new ValidatorCacheManager<unknown, unknown, ValidationResult<ErrorType, ChildrenVResults>>();

  constructor(
    validations: ValidationFunctionAdapted<
      Value,
      ContextType,
      ValidationResult<ErrorType, ChildrenVResults | null>
    >[] = [],
  ...
  validate(
    value: Value,
    ...rest: ContextType extends null ? [undefined?] : [ContextType]
    ...
    let lastFormResult:
      | null
      | (ValidationResult<ErrorType, ChildrenVResults> extends ValidationResult<any, infer FieldsResults>
          ? FieldsResults
          : null) = null;
